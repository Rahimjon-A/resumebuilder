...
const View = ({ input }) => {
  return (
    <div className="bg-[#ffffff] p-[30px] border">
      <div className="max-w-[400px] w-full h-[1px] bg-[#343434]" />
        ...
        <div className="">
          ...
          <div className="pt-[20px] flex gap-[50px]">
            <span>
              ...
              <p className="text-[14px] text-[#a9abb1]">{input.email}</p>
            </span>
            <span>
        ...
        <span className="flex gap-2 flex-col">
          <div className="flex gap-1.5 items-center">
            {input.techSkils.length > 0 ? (
              <div className="w-[10px] h-[10px]   bg-[#999999]" />
            ) : (
              ""
            )}
            <h2>Technical skills:</h2>{" "}
            <p className="w-[80%]">{input.techSkils}</p>
          </div>
          <div className="flex gap-1.5 items-center">
            ...
            <h2>Soft skills:</h2> <p>{input.softSkils}</p>
          </div>
        </span>
      </div>
      <div className="">
        ...
        <div className="flex gap-1.5 items-center">
          ...
          <p className="w-[80%] capitalize">{input.language1}</p>
        </div>{" "}
        <div className="flex gap-1.5 items-center">
          ...
          <p className="w-[80%] capitalize">{input.language2}</p>
        </div>{" "}
        <div className="flex gap-1.5 items-center">
          ...
          <p className="w-[80%] capitalize">{input.language3}</p>
        </div>{" "}
        <div className="flex gap-1.5 items-center">
